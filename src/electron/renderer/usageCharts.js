...
(function exposeUsageCharts(root, factory) {
  ...
  const clientColors = {
    ...
    moonshot: '#16191e', zai: '#000000', zaiteam: '#000000', cohere: '#39594d', xiaomi: '#ff6700', minimax: '#f23f5d', doubao: '#1E37FC', volcengine: '#006EFF', qoder: '#2ADB5C', ollama: '#888888', wecode: '#E6162D', thirdparty: '#DD2E57',
    default: '#6ab4f0'
  };
